...
gossip_topo( config_t * config ) {
  ...
  fd_topos_net_tiles( topo, 1UL, &config->net, config->tiles.netlink.max_routes, config->tiles.netlink.max_peer_routes, config->tiles.netlink.max_neighbors, config->tiles.netlink.max_addrs, tile_to_cpu );
